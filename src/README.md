...
seq_model.py         CNN encoder + RNN/GRU/LSTM decoder options
...
```bash
python3 -m src.train_sequence --dataset pubchem --epochs 10 --batch-size 16 --learning-rate 0.001 --hidden-dim 256 --embedding-dim 128 --decoder-type gru
```
